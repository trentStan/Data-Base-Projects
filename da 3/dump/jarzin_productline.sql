...
CREATE TABLE `productline` (
  `prodLineNo` int(11) NOT NULL AUTO_INCREMENT,
  `lineName` varchar(50) DEFAULT NULL,
  `descript` text,
  PRIMARY KEY (`prodLineNo`),
  UNIQUE KEY `prodLineNo_UNIQUE` (`prodLineNo`)
...
INSERT INTO `productline` VALUES (1,'Cadbury','They are a sweets manufacturer');
